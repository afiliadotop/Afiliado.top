...
def card(p):
    ...
    cta_text = "Garantir oferta Posthaus" if p["discount"] >= 20 else "Ver na Posthaus"
    return f"""
                    <a href="{html.escape(p['link'])}" target="_blank" rel="sponsored"
                        ...
                        <div class="p-4 flex flex-col flex-1">
                            ...
                            <button class="btn-ph w-full bg-pink-600 hover:bg-pink-700 text-white text-sm font-bold py-2.5 rounded-lg transition">
                                {cta_text} &rarr;
                            </button>
                        </div>
                    </a>"""
